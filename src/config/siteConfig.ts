...
export const siteConfig: SiteConfig = {
  ...
  anime: {
    mode: "bangumi", // 番剧页面模式："bangumi" 使用Bangumi API
  },
  ...
  banner: {
    ...
    src: {
      desktop: ["Dorathy_Jill_smallver.webp"], // 桌面横幅图片
      mobile: ["Dorathy_Jill.webp"], // 移动横幅图片
    }, // 使用本地横幅图片
    ...
    credit: {
      ...
      text: "Va-11_Hall-A Glitch City", // 要显示的来源文本
      url: "https://www.pixiv.net/artworks/93080601", // 原始艺术品或艺术家页面的 URL 链接
    },
  ...
  toc: {
    ...
    useJapaneseBadge: false, // 恢复旧配置：不使用日语假名标记
  },
  showCoverInContent: true, // 在文章内容页显示文章封面
  generateOgImages: true, // 恢复旧配置：启用生成OpenGraph图片功能
  favicon: [
    // 留空以使用默认 favicon
  ],
  ...
  font: {
    ...
    cjkFont: {
      // 中日韩字体 - 作为回退字体
      fontFamily: "MarukoGothicCJKsc-Medium",
      fontWeight: "500",
      localFonts: ["MarukoGothicCJKsc-Medium.ttf"],
      enableCompress: true, // 启用字体子集优化，减少字体文件大小
    },
  },
