!((t) => {
	...
	(t, i, e) => {
		...
		(r.prototype.getModelMatrix = function () {
			...
			(r.prototype.loadTexture = function (t, i, e) {
				...
				r.loadTexture(this.live2DModel, t, i, () => {
					d--, 0 == d && (this.isTexLoaded = !0), "function" == typeof e && e();
				});
			}),
			...
			(r.prototype.loadExpression = function (t, i, e) {
				...
				r.loadBytes(i, (i) => {
					null != t && (this.expressions[t] = o.loadJson(i)),
						"function" == typeof e && e();
				});
			}),
			(r.prototype.loadPose = function (t, i) {
				...
				try {
					e.loadBytes(t, (t) => {
						(this.pose = $.load(t)), "function" == typeof i && i();
					});
				} catch (t) {
					console.warn(t);
				}
		...
		(g.STATE_FIRST = "STATE_FIRST"),
			...
			(c.getPlatformManager = () => c.platformManager),
			(c.setPlatformManager = (t) => {
				c.platformManager = t;
			}),
			(t.exports = {
				L2DTargetPoint: p,
		...
		((t) => {
			!(() => {
				...
				(i._$0s = 1),
					...
					(i.prototype._$Rs = () => (_._$li("_$60 _$PT _$Rs()"), -1)),
					(i.prototype._$Ds = (t) => {
						...
						if (0 != e)
							if (1 == t.length) {
								...
								for (var u = 0; u < t.length; u++) {
									var _ = t[u],
										p = 0 != this.getParamFloat(_);
									if (p) {
										if (o >= 0) break;
										o = u;
										var h = i[u];
										(n = this.getPartsOpacity(h)),
											(n += e / r),
											n > 1 && (n = 1);
									}
								}
								...
								for (var u = 0; u < t.length; u++) {
									var h = i[u];
									if (o == u) this.setPartsOpacity(h, n);
									else {
										var f,
											c = this.getPartsOpacity(h);
										f = n < 0.5 ? (-0.5 * n) / 0.5 + 1 : (0.5 * (1 - n)) / 0.5;
										var d = (1 - f) * (1 - n);
										d > 0.15 && (f = 1 - 0.15 / (1 - n)),
											c > f && (c = f),
											this.setPartsOpacity(h, c);
									}
								}
							}
						else
					...
					(s.prototype.getDurationMSec = () => -1),
					(s.prototype.getLoopDurationMSec = () => -1),
					...
					(s.prototype.updateParamExe = (t, i, e, r) => {}),
					(_._$8s = 0),
					(_._$fT = new Object()),
					(_.start = (t) => {
						var i = _._$fT[t];
				...
				(It._$ni = (t, i, e, r, o, n, s, _, a) => {
					...
					(M._$or = () => M._$52),
					(M._$Pr = () => M._$R2),
					(M.prototype.convertClipIDForV2_11 = (t) => {
						var i = [];
						return null == t
							? null
							: 0 == t.length
					...
					(M.prototype.getOpacity = (t, i) => i._$7s),
					(M.prototype._$zS = (t, i) => i._$Us),
					(M.prototype._$MS = (t) => {
					...
					(M.prototype.preDraw = (t, i, e) => {}),
					(M.prototype.draw = (t, i, e) => {}),
					(M.prototype.getType = () => {}),
					(M.prototype._$B2 = (t, i, e) => {}),
					(E._$ps = 32),
					...
					(E.prototype._$ZT = () => {}),
					(E.prototype._$Uo = (t, i, e, r, o, n, s) => {}),
					(E.prototype._$Rs = () => -1),
					(E.prototype._$Ds = (t) => {}),
					...
					(w.getUserTimeMSec = () =>
						w._$CS == w._$W2 ? w.getSystemTimeMSec() : w._$CS),
					(w.setUserTimeMSec = (t) => {
						w._$CS = t;
					}),
					(w.updateUserTimeMSec = () => (w._$CS = w.getSystemTimeMSec())),
					(w.getTimeMSec = () => new Date().getTime()),
					(w.getSystemTimeMSec = () => new Date().getTime()),
					(w._$Q = (t) => {}),
					(w._$jT = (t, i, e, r, o) => {
					...
					(O.getChar = (t, i) => String.fromCharCode(t.getUint8(i))),
					(O.createString = (t, i, e) => {
						for (
				...
				(wt.STATE_FIRST = "STATE_FIRST"),
					...
					(X._$vS = null),
					(X._$no = null),
					(X._$9r = (t) => new Float32Array(t)),
					(X._$vb = (t) => new Int16Array(t)),
					(X._$cr = (t, i) => (
					...
					(z.prototype._$Nr = function (t, i) {
						...
						if (this._$GS._$Ur(t)) {
							...
							if ((this._$GS._$zr(n, s, o), o <= 0)) {
								...
								for (
									var j = 0 | (2 ** o), q = new Float32Array(j), J = 0;
									J < j;
									J++
								) {
					...
					(W.prototype.getOpacity = (t, i) => i._$7s),
					(W.prototype._$zS = (t, i) => i._$Us),
				...
				(at._$yr = !1),
					...
					(at.getVersionStr = () => at._$2s),
					(at.getVersionNo = () => at._$Kr),
					(at._$sT = (t) => {
						at._$cT = t;
					}),
					(at.getError = () => {
					...
					(at.getGL = (t) => at.glContext[t]),
					(at.setClippingMaskBufferSize = (t) => {
						at.clippingMaskBufferSize = t;
					}),
					(at.getClippingMaskBufferSize = () => at.clippingMaskBufferSize),
					(at.deleteBuffer = (t) => {
					...
					(ht._$r2 = (t) =>
						t < 0 ? 0 : t > 1 ? 1 : 0.5 - 0.5 * Math.cos(t * Lt.PI_F)),
					(lt._$fr = -1),
					...
					(yt._$tP = new Object()),
					(yt._$2o = () => (
						null == yt._$eT && (yt._$eT = yt.getID("DST_BASE")), yt._$eT
					)),
					(yt._$27 = () => {
					...
					(yt.prototype._$3s = () => new yt()),
					(mt.prototype = new E()),
					(mt._$9r = (t) => new Float32Array(t)),
					(mt._$vb = (t) => new Int16Array(t)),
					(mt._$cr = (t, i) => (
						null == t || t._$yL() < i.length
				...
				(St.prototype._$bT = function () {
					...
					(Et.isIPhone = () => (
						Et.SYSTEM_INFO || Et.setup(), Et.SYSTEM_INFO._isIPhone
					)),
					(Et.isIOS = () => (
					...
					(Et.isAndroid = () => (
						Et.SYSTEM_INFO || Et.setup(), Et.SYSTEM_INFO._isAndroid
					)),
					(Et.getOSVersion = () => (
		...
		(o.prototype = new n.L2DBaseModel()),
			(o.prototype.load = function (t, i, e) {
				...
				this.modelSetting.loadModelSetting(i, () => {
					var t = this.modelHomeDir + this.modelSetting.getModelFile();
					this.loadModelData(t, (t) => {
						for (var i = 0; i < this.modelSetting.getTextureNum(); i++) {
							if (
								/^https?:\/\/|^\/\//i.test(this.modelSetting.getTextureFile(i))
							)
								var o = this.modelSetting.getTextureFile(i);
							else
								var o = this.modelHomeDir + this.modelSetting.getTextureFile(i);
							this.loadTexture(i, o, () => {
								if (this.isTexLoaded) {
									if (this.modelSetting.getExpressionNum() > 0) {
										this.expressions = {};
										for (
											var t = 0;
											t < this.modelSetting.getExpressionNum();
											t++
										) {
											var i = this.modelSetting.getExpressionName(t),
												o =
													this.modelHomeDir +
													this.modelSetting.getExpressionFile(t);
											this.loadExpression(i, o);
										}
									} else
										(this.expressionManager = null), (this.expressions = {});
									if (
										(this.eyeBlink,
										null != this.modelSetting.getPhysicsFile()
											? this.loadPhysics(
													this.modelHomeDir +
														this.modelSetting.getPhysicsFile(),
												)
											: (this.physics = null),
										...
										var n = this.modelSetting.getLayout();
										null != n.width && this.modelMatrix.setWidth(n.width),
											null != n.height && this.modelMatrix.setHeight(n.height),
											null != n.x && this.modelMatrix.setX(n.x),
											null != n.y && this.modelMatrix.setY(n.y),
											null != n.center_x &&
												this.modelMatrix.centerX(n.center_x),
											null != n.center_y &&
												this.modelMatrix.centerY(n.center_y),
											null != n.top && this.modelMatrix.top(n.top),
											null != n.bottom && this.modelMatrix.bottom(n.bottom),
											null != n.left && this.modelMatrix.left(n.left),
											null != n.right && this.modelMatrix.right(n.right);
									}
									if (null != this.modelSetting.getHitAreasCustom()) {
										var s = this.modelSetting.getHitAreasCustom();
										null != s.head_x &&
									...
									for (var t = 0; t < this.modelSetting.getInitParamNum(); t++)
									...
									for (
										var t = 0;
										t < this.modelSetting.getInitPartsVisibleNum();
										t++
									)
									...
									this.live2DModel.saveParam(),
										this.preloadMotionGroup(h.default.MOTION_GROUP_IDLE),
										this.preloadMotionGroup(h.default.MOTION_GROUP_SLEEPY),
			...
			(o.prototype.preloadMotionGroup = function (t) {
				for (var e = 0; e < this.modelSetting.getMotionNum(t); e++) {
			...
			(o.prototype.startMotion = function (t, i, e) {
				...
				null == this.motions[t]
					? this.loadMotion(null, this.modelHomeDir + r, (r) => {
							(o = r), this.setFadeInFadeOut(t, i, e, o);
						})
